...
/**
 * The persistent class for the TMP_CUSTSTATE4 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE4")
@NamedQuery(name="TmpCuststate4.findAll", query="SELECT t FROM TmpCuststate4 t")
public class TmpCuststate4 implements Serializable {
