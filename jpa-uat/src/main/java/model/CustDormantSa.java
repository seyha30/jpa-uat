...
/**
 * The persistent class for the CUST_DORMANT_SA database table.
 * 
 */
@Entity
@Table(name="CUST_DORMANT_SA")
@NamedQuery(name="CustDormantSa.findAll", query="SELECT c FROM CustDormantSa c")
public class CustDormantSa implements Serializable {
