...
/**
 * The persistent class for the TMP_CUSTSTATE7 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE7")
@NamedQuery(name="TmpCuststate7.findAll", query="SELECT t FROM TmpCuststate7 t")
public class TmpCuststate7 implements Serializable {
