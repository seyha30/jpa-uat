...
/**
 * The persistent class for the TMP_CUSTSTATE20 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE20")
@NamedQuery(name="TmpCuststate20.findAll", query="SELECT t FROM TmpCuststate20 t")
public class TmpCuststate20 implements Serializable {
