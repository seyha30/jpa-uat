...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_25 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_25")
@NamedQuery(name="SysExportSchema25.findAll", query="SELECT s FROM SysExportSchema25 s")
public class SysExportSchema25 implements Serializable {
