...
/**
 * The persistent class for the TMP_CUSTSTATE54 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE54")
@NamedQuery(name="TmpCuststate54.findAll", query="SELECT t FROM TmpCuststate54 t")
public class TmpCuststate54 implements Serializable {
