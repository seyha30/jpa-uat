...
/**
 * The persistent class for the BACKUP_TRANSFER_TEMP database table.
 * 
 */
@Entity
@Table(name="BACKUP_TRANSFER_TEMP")
@NamedQuery(name="BackupTransferTemp.findAll", query="SELECT b FROM BackupTransferTemp b")
public class BackupTransferTemp implements Serializable {
