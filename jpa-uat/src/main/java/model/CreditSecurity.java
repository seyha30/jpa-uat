...
/**
 * The persistent class for the CREDIT_SECURITY database table.
 * 
 */
@Entity
@Table(name="CREDIT_SECURITY")
@NamedQuery(name="CreditSecurity.findAll", query="SELECT c FROM CreditSecurity c")
public class CreditSecurity implements Serializable {
