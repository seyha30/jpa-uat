...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_10 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_10")
@NamedQuery(name="SysExportSchema10.findAll", query="SELECT s FROM SysExportSchema10 s")
public class SysExportSchema10 implements Serializable {
