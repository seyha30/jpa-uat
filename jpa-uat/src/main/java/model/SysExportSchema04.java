...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_04 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_04")
@NamedQuery(name="SysExportSchema04.findAll", query="SELECT s FROM SysExportSchema04 s")
public class SysExportSchema04 implements Serializable {
