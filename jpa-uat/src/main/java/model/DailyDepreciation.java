...
/**
 * The persistent class for the DAILY_DEPRECIATION database table.
 * 
 */
@Entity
@Table(name="DAILY_DEPRECIATION")
@NamedQuery(name="DailyDepreciation.findAll", query="SELECT d FROM DailyDepreciation d")
public class DailyDepreciation implements Serializable {
