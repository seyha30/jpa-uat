...
/**
 * The persistent class for the TMP_CUSTSTATE31 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE31")
@NamedQuery(name="TmpCuststate31.findAll", query="SELECT t FROM TmpCuststate31 t")
public class TmpCuststate31 implements Serializable {
