...
/**
 * The persistent class for the TMP_CUSTSTATE18 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE18")
@NamedQuery(name="TmpCuststate18.findAll", query="SELECT t FROM TmpCuststate18 t")
public class TmpCuststate18 implements Serializable {
