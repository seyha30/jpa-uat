...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_17 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_17")
@NamedQuery(name="SysExportSchema17.findAll", query="SELECT s FROM SysExportSchema17 s")
public class SysExportSchema17 implements Serializable {
