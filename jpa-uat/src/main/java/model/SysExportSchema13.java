...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_13 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_13")
@NamedQuery(name="SysExportSchema13.findAll", query="SELECT s FROM SysExportSchema13 s")
public class SysExportSchema13 implements Serializable {
