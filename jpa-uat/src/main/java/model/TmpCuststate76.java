...
/**
 * The persistent class for the TMP_CUSTSTATE76 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE76")
@NamedQuery(name="TmpCuststate76.findAll", query="SELECT t FROM TmpCuststate76 t")
public class TmpCuststate76 implements Serializable {
