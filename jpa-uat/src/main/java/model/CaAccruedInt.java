...
/**
 * The persistent class for the CA_ACCRUED_INT database table.
 * 
 */
@Entity
@Table(name="CA_ACCRUED_INT")
@NamedQuery(name="CaAccruedInt.findAll", query="SELECT c FROM CaAccruedInt c")
public class CaAccruedInt implements Serializable {
