...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_11 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_11")
@NamedQuery(name="SysExportSchema11.findAll", query="SELECT s FROM SysExportSchema11 s")
public class SysExportSchema11 implements Serializable {
