...
/**
 * The persistent class for the TMP_ACCINTSA database table.
 * 
 */
@Entity
@Table(name="TMP_ACCINTSA")
@NamedQuery(name="TmpAccintsa.findAll", query="SELECT t FROM TmpAccintsa t")
public class TmpAccintsa implements Serializable {
