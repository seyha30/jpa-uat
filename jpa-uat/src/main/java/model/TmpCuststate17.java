...
/**
 * The persistent class for the TMP_CUSTSTATE17 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE17")
@NamedQuery(name="TmpCuststate17.findAll", query="SELECT t FROM TmpCuststate17 t")
public class TmpCuststate17 implements Serializable {
