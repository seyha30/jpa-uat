...
/**
 * The persistent class for the TRANX_MASTERXPOST database table.
 * 
 */
@Entity
@Table(name="TRANX_MASTERXPOST")
@NamedQuery(name="TranxMasterxpost.findAll", query="SELECT t FROM TranxMasterxpost t")
public class TranxMasterxpost implements Serializable {
