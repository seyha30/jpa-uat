...
/**
 * The persistent class for the FIXED_DEPOSIT_ROLLOVER database table.
 * 
 */
@Entity
@Table(name="FIXED_DEPOSIT_ROLLOVER")
@NamedQuery(name="FixedDepositRollover.findAll", query="SELECT f FROM FixedDepositRollover f")
public class FixedDepositRollover implements Serializable {
