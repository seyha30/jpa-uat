...
/**
 * The persistent class for the LOAN_ACCRUED_REPORT database table.
 * 
 */
@Entity
@Table(name="LOAN_ACCRUED_REPORT")
@NamedQuery(name="LoanAccruedReport.findAll", query="SELECT l FROM LoanAccruedReport l")
public class LoanAccruedReport implements Serializable {
