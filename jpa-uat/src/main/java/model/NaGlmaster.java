...
/**
 * The persistent class for the NA_GLMASTER database table.
 * 
 */
@Entity
@Table(name="NA_GLMASTER")
@NamedQuery(name="NaGlmaster.findAll", query="SELECT n FROM NaGlmaster n")
public class NaGlmaster implements Serializable {
