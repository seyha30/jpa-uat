...
/**
 * The persistent class for the TEMPCC_AUTODORC database table.
 * 
 */
@Entity
@Table(name="TEMPCC_AUTODORC")
@NamedQuery(name="TempccAutodorc.findAll", query="SELECT t FROM TempccAutodorc t")
public class TempccAutodorc implements Serializable {
