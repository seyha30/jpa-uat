...
/**
 * The persistent class for the TMP_CUSTSTATE15 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE15")
@NamedQuery(name="TmpCuststate15.findAll", query="SELECT t FROM TmpCuststate15 t")
public class TmpCuststate15 implements Serializable {
