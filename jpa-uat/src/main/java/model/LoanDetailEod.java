...
/**
 * The persistent class for the LOAN_DETAIL_EOD database table.
 * 
 */
@Entity
@Table(name="LOAN_DETAIL_EOD")
@NamedQuery(name="LoanDetailEod.findAll", query="SELECT l FROM LoanDetailEod l")
public class LoanDetailEod implements Serializable {
