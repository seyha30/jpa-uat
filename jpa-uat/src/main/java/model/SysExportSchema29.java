...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_29 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_29")
@NamedQuery(name="SysExportSchema29.findAll", query="SELECT s FROM SysExportSchema29 s")
public class SysExportSchema29 implements Serializable {
