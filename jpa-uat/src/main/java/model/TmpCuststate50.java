...
/**
 * The persistent class for the TMP_CUSTSTATE50 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE50")
@NamedQuery(name="TmpCuststate50.findAll", query="SELECT t FROM TmpCuststate50 t")
public class TmpCuststate50 implements Serializable {
