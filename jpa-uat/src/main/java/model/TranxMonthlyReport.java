...
/**
 * The persistent class for the TRANX_MONTHLY_REPORT database table.
 * 
 */
@Entity
@Table(name="TRANX_MONTHLY_REPORT")
@NamedQuery(name="TranxMonthlyReport.findAll", query="SELECT t FROM TranxMonthlyReport t")
public class TranxMonthlyReport implements Serializable {
