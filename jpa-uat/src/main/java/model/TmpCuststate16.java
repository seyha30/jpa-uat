...
/**
 * The persistent class for the TMP_CUSTSTATE16 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE16")
@NamedQuery(name="TmpCuststate16.findAll", query="SELECT t FROM TmpCuststate16 t")
public class TmpCuststate16 implements Serializable {
