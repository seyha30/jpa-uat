...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_31 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_31")
@NamedQuery(name="SysExportSchema31.findAll", query="SELECT s FROM SysExportSchema31 s")
public class SysExportSchema31 implements Serializable {
