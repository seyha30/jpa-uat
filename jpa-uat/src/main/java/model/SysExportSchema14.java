...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_14 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_14")
@NamedQuery(name="SysExportSchema14.findAll", query="SELECT s FROM SysExportSchema14 s")
public class SysExportSchema14 implements Serializable {
