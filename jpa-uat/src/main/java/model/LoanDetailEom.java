...
/**
 * The persistent class for the LOAN_DETAIL_EOM database table.
 * 
 */
@Entity
@Table(name="LOAN_DETAIL_EOM")
@NamedQuery(name="LoanDetailEom.findAll", query="SELECT l FROM LoanDetailEom l")
public class LoanDetailEom implements Serializable {
	...
	@Column(name="FEE_EXP_EOM")
	private BigDecimal feeExpEom;
	...
	@Column(name="INT_EXP_EOM")
	private BigDecimal intExpEom;
	...
	@Column(name="PRIN_EXP_EOM")
	private BigDecimal prinExpEom;
	...
	public BigDecimal getFeeExpEom() {
		return this.feeExpEom;
	}

	public void setFeeExpEom(BigDecimal feeExpEom) {
		this.feeExpEom = feeExpEom;
	}
	...
	public BigDecimal getIntExpEom() {
		return this.intExpEom;
	}

	public void setIntExpEom(BigDecimal intExpEom) {
		this.intExpEom = intExpEom;
	}
	...
	public BigDecimal getPrinExpEom() {
		return this.prinExpEom;
	}

	public void setPrinExpEom(BigDecimal prinExpEom) {
		this.prinExpEom = prinExpEom;
	}
