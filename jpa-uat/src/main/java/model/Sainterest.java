...
/**
 * The persistent class for the SAINTEREST database table.
 * 
 */
@Entity
@NamedQuery(name="Sainterest.findAll", query="SELECT s FROM Sainterest s")
public class Sainterest implements Serializable {
