...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_20 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_20")
@NamedQuery(name="SysExportSchema20.findAll", query="SELECT s FROM SysExportSchema20 s")
public class SysExportSchema20 implements Serializable {
