...
/**
 * The persistent class for the TMP_CUSTSTATE37 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE37")
@NamedQuery(name="TmpCuststate37.findAll", query="SELECT t FROM TmpCuststate37 t")
public class TmpCuststate37 implements Serializable {
