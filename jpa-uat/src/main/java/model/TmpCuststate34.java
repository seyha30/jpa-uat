...
/**
 * The persistent class for the TMP_CUSTSTATE34 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE34")
@NamedQuery(name="TmpCuststate34.findAll", query="SELECT t FROM TmpCuststate34 t")
public class TmpCuststate34 implements Serializable {
