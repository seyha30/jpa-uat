...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_19 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_19")
@NamedQuery(name="SysExportSchema19.findAll", query="SELECT s FROM SysExportSchema19 s")
public class SysExportSchema19 implements Serializable {
