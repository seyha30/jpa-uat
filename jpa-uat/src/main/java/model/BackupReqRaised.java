...
/**
 * The persistent class for the BACKUP_REQ_RAISED database table.
 * 
 */
@Entity
@Table(name="BACKUP_REQ_RAISED")
@NamedQuery(name="BackupReqRaised.findAll", query="SELECT b FROM BackupReqRaised b")
public class BackupReqRaised implements Serializable {
