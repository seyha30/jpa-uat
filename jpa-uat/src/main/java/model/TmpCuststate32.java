...
/**
 * The persistent class for the TMP_CUSTSTATE32 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE32")
@NamedQuery(name="TmpCuststate32.findAll", query="SELECT t FROM TmpCuststate32 t")
public class TmpCuststate32 implements Serializable {
