...
/**
 * The persistent class for the TMP_CUSTSTATE35 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE35")
@NamedQuery(name="TmpCuststate35.findAll", query="SELECT t FROM TmpCuststate35 t")
public class TmpCuststate35 implements Serializable {
