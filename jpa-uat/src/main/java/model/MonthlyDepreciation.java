...
/**
 * The persistent class for the MONTHLY_DEPRECIATION database table.
 * 
 */
@Entity
@Table(name="MONTHLY_DEPRECIATION")
@NamedQuery(name="MonthlyDepreciation.findAll", query="SELECT m FROM MonthlyDepreciation m")
public class MonthlyDepreciation implements Serializable {
