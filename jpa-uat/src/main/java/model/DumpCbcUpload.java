...
/**
 * The persistent class for the DUMP_CBC_UPLOAD database table.
 * 
 */
@Entity
@Table(name="DUMP_CBC_UPLOAD")
@NamedQuery(name="DumpCbcUpload.findAll", query="SELECT d FROM DumpCbcUpload d")
public class DumpCbcUpload implements Serializable {
	...
	@Column(name="CALLATERAL_A172")
	private String callateralA172;

	private String ccy162;

	private String city38;

	@Column(name="INSTALLMENT_AMOUNT_A167")
	private BigDecimal installmentAmountA167;

	@Column(name="LAST_AMT_PAID171")
	private BigDecimal lastAmtPaid171;

	@Column(name="LASTPAYDATE_170")
	private String lastpaydate170;

	private BigDecimal limit163;

	@Column(name="NEXT_REPAY_AMT_175")
	private String nextRepayAmt175;

	@Column(name="OUTSTANDING_173")
	private BigDecimal outstanding173;

	@Column(name="PAST_DUE_AMT174")
	private BigDecimal pastDueAmt174;

	private String rest166;

	private String rs176;

	private BigDecimal tenure169;

	public DumpCbcUpload() {
	}
	...
	public String getCallateralA172() {
		return this.callateralA172;
	}

	public void setCallateralA172(String callateralA172) {
		this.callateralA172 = callateralA172;
	}

	public String getCcy162() {
		return this.ccy162;
	}

	public void setCcy162(String ccy162) {
		this.ccy162 = ccy162;
	}

	public String getCity38() {
		return this.city38;
	}

	public void setCity38(String city38) {
		this.city38 = city38;
	}

	public BigDecimal getInstallmentAmountA167() {
		return this.installmentAmountA167;
	}

	public void setInstallmentAmountA167(BigDecimal installmentAmountA167) {
		this.installmentAmountA167 = installmentAmountA167;
	}

	public BigDecimal getLastAmtPaid171() {
		return this.lastAmtPaid171;
	}

	public void setLastAmtPaid171(BigDecimal lastAmtPaid171) {
		this.lastAmtPaid171 = lastAmtPaid171;
	}

	public String getLastpaydate170() {
		return this.lastpaydate170;
	}

	public void setLastpaydate170(String lastpaydate170) {
		this.lastpaydate170 = lastpaydate170;
	}

	public BigDecimal getLimit163() {
		return this.limit163;
	}

	public void setLimit163(BigDecimal limit163) {
		this.limit163 = limit163;
	}

	public String getNextRepayAmt175() {
		return this.nextRepayAmt175;
	}

	public void setNextRepayAmt175(String nextRepayAmt175) {
		this.nextRepayAmt175 = nextRepayAmt175;
	}

	public BigDecimal getOutstanding173() {
		return this.outstanding173;
	}

	public void setOutstanding173(BigDecimal outstanding173) {
		this.outstanding173 = outstanding173;
	}

	public BigDecimal getPastDueAmt174() {
		return this.pastDueAmt174;
	}

	public void setPastDueAmt174(BigDecimal pastDueAmt174) {
		this.pastDueAmt174 = pastDueAmt174;
	}

	public String getRest166() {
		return this.rest166;
	}

	public void setRest166(String rest166) {
		this.rest166 = rest166;
	}

	public String getRs176() {
		return this.rs176;
	}

	public void setRs176(String rs176) {
		this.rs176 = rs176;
	}

	public BigDecimal getTenure169() {
		return this.tenure169;
	}

	public void setTenure169(BigDecimal tenure169) {
		this.tenure169 = tenure169;
	}
