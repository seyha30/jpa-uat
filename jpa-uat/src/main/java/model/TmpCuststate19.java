...
/**
 * The persistent class for the TMP_CUSTSTATE19 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE19")
@NamedQuery(name="TmpCuststate19.findAll", query="SELECT t FROM TmpCuststate19 t")
public class TmpCuststate19 implements Serializable {
