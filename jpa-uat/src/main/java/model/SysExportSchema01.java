...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_01 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_01")
@NamedQuery(name="SysExportSchema01.findAll", query="SELECT s FROM SysExportSchema01 s")
public class SysExportSchema01 implements Serializable {
