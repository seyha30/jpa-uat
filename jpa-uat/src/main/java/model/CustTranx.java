...
/**
 * The persistent class for the CUST_TRANX database table.
 * 
 */
@Entity
@Table(name="CUST_TRANX")
@NamedQuery(name="CustTranx.findAll", query="SELECT c FROM CustTranx c")
public class CustTranx implements Serializable {
