...
/**
 * The persistent class for the CLVW_CREDIT_OFFICER_VARIABLE database table.
 * 
 */
@Entity
@Table(name="CLVW_CREDIT_OFFICER_VARIABLE")
@NamedQuery(name="ClvwCreditOfficerVariable.findAll", query="SELECT c FROM ClvwCreditOfficerVariable c")
public class ClvwCreditOfficerVariable implements Serializable {
	...
	public ClvwCreditOfficerVariable() {
	}
