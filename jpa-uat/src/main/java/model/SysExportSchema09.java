...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_09 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_09")
@NamedQuery(name="SysExportSchema09.findAll", query="SELECT s FROM SysExportSchema09 s")
public class SysExportSchema09 implements Serializable {
