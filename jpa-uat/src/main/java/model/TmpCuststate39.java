...
/**
 * The persistent class for the TMP_CUSTSTATE39 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE39")
@NamedQuery(name="TmpCuststate39.findAll", query="SELECT t FROM TmpCuststate39 t")
public class TmpCuststate39 implements Serializable {
