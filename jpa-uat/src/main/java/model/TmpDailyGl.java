...
/**
 * The persistent class for the TMP_DAILY_GL database table.
 * 
 */
@Entity
@Table(name="TMP_DAILY_GL")
@NamedQuery(name="TmpDailyGl.findAll", query="SELECT t FROM TmpDailyGl t")
public class TmpDailyGl implements Serializable {
