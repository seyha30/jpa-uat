...
/**
 * The persistent class for the ACVW_ACCT_ENTRIES database table.
 * 
 */
@Entity
@Table(name="ACVW_ACCT_ENTRIES")
@NamedQuery(name="AcvwAcctEntry.findAll", query="SELECT a FROM AcvwAcctEntry a")
public class AcvwAcctEntry implements Serializable {
