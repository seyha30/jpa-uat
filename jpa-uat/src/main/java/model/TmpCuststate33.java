...
/**
 * The persistent class for the TMP_CUSTSTATE33 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE33")
@NamedQuery(name="TmpCuststate33.findAll", query="SELECT t FROM TmpCuststate33 t")
public class TmpCuststate33 implements Serializable {
