...
/**
 * The persistent class for the TMP_CUSTSTATE5 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE5")
@NamedQuery(name="TmpCuststate5.findAll", query="SELECT t FROM TmpCuststate5 t")
public class TmpCuststate5 implements Serializable {
