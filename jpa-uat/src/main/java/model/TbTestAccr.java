...
/**
 * The persistent class for the TB_TEST_ACCR database table.
 * 
 */
@Entity
@Table(name="TB_TEST_ACCR")
@NamedQuery(name="TbTestAccr.findAll", query="SELECT t FROM TbTestAccr t")
public class TbTestAccr implements Serializable {
