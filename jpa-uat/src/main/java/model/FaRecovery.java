...
/**
 * The persistent class for the FA_RECOVERY database table.
 * 
 */
@Entity
@Table(name="FA_RECOVERY")
@NamedQuery(name="FaRecovery.findAll", query="SELECT f FROM FaRecovery f")
public class FaRecovery implements Serializable {
