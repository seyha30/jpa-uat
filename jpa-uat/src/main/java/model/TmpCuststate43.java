...
/**
 * The persistent class for the TMP_CUSTSTATE43 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE43")
@NamedQuery(name="TmpCuststate43.findAll", query="SELECT t FROM TmpCuststate43 t")
public class TmpCuststate43 implements Serializable {
