...
/**
 * The persistent class for the TMP_CUSTSTATE0 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE0")
@NamedQuery(name="TmpCuststate0.findAll", query="SELECT t FROM TmpCuststate0 t")
public class TmpCuststate0 implements Serializable {
