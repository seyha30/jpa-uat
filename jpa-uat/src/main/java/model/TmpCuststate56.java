...
/**
 * The persistent class for the TMP_CUSTSTATE56 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE56")
@NamedQuery(name="TmpCuststate56.findAll", query="SELECT t FROM TmpCuststate56 t")
public class TmpCuststate56 implements Serializable {
