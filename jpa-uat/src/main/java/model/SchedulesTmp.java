...
/**
 * The persistent class for the SCHEDULES_TMP database table.
 * 
 */
@Entity
@Table(name="SCHEDULES_TMP")
@NamedQuery(name="SchedulesTmp.findAll", query="SELECT s FROM SchedulesTmp s")
public class SchedulesTmp implements Serializable {
