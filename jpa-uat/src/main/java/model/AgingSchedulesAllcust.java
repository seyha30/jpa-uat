...
/**
 * The persistent class for the AGING_SCHEDULES_ALLCUST database table.
 * 
 */
@Entity
@Table(name="AGING_SCHEDULES_ALLCUST")
@NamedQuery(name="AgingSchedulesAllcust.findAll", query="SELECT a FROM AgingSchedulesAllcust a")
public class AgingSchedulesAllcust implements Serializable {
	...
	@Column(name="TOTAL_OLB")
	private BigDecimal totalOlb;

	public AgingSchedulesAllcust() {
	}
	...
	public BigDecimal getTotalOlb() {
		return this.totalOlb;
	}

	public void setTotalOlb(BigDecimal totalOlb) {
		this.totalOlb = totalOlb;
	}
