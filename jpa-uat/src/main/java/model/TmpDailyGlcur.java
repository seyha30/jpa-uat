...
/**
 * The persistent class for the TMP_DAILY_GLCUR database table.
 * 
 */
@Entity
@Table(name="TMP_DAILY_GLCUR")
@NamedQuery(name="TmpDailyGlcur.findAll", query="SELECT t FROM TmpDailyGlcur t")
public class TmpDailyGlcur implements Serializable {
