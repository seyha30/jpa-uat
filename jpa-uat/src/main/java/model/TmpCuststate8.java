...
/**
 * The persistent class for the TMP_CUSTSTATE8 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE8")
@NamedQuery(name="TmpCuststate8.findAll", query="SELECT t FROM TmpCuststate8 t")
public class TmpCuststate8 implements Serializable {
