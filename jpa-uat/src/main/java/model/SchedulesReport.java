...
/**
 * The persistent class for the SCHEDULES_REPORT database table.
 * 
 */
@Entity
@Table(name="SCHEDULES_REPORT")
@NamedQuery(name="SchedulesReport.findAll", query="SELECT s FROM SchedulesReport s")
public class SchedulesReport implements Serializable {
