...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_16 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_16")
@NamedQuery(name="SysExportSchema16.findAll", query="SELECT s FROM SysExportSchema16 s")
public class SysExportSchema16 implements Serializable {
