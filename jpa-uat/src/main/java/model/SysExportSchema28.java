...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_28 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_28")
@NamedQuery(name="SysExportSchema28.findAll", query="SELECT s FROM SysExportSchema28 s")
public class SysExportSchema28 implements Serializable {
