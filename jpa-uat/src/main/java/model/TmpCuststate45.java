...
/**
 * The persistent class for the TMP_CUSTSTATE45 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE45")
@NamedQuery(name="TmpCuststate45.findAll", query="SELECT t FROM TmpCuststate45 t")
public class TmpCuststate45 implements Serializable {
