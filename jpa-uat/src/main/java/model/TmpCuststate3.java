...
/**
 * The persistent class for the TMP_CUSTSTATE3 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE3")
@NamedQuery(name="TmpCuststate3.findAll", query="SELECT t FROM TmpCuststate3 t")
public class TmpCuststate3 implements Serializable {
