...
/**
 * The persistent class for the TMP_CUSTSTATE10 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE10")
@NamedQuery(name="TmpCuststate10.findAll", query="SELECT t FROM TmpCuststate10 t")
public class TmpCuststate10 implements Serializable {
