...
/**
 * The persistent class for the TMP_CUSTSTATE21 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE21")
@NamedQuery(name="TmpCuststate21.findAll", query="SELECT t FROM TmpCuststate21 t")
public class TmpCuststate21 implements Serializable {
