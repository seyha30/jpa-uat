...
/**
 * The persistent class for the M_A_M_CRITERIA database table.
 * 
 */
@Entity
@Table(name="M_A_M_CRITERIA")
@NamedQuery(name="MAMCriteria.findAll", query="SELECT m FROM MAMCriteria m")
public class MAMCriteria implements Serializable {
