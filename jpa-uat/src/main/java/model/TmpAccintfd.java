...
/**
 * The persistent class for the TMP_ACCINTFD database table.
 * 
 */
@Entity
@Table(name="TMP_ACCINTFD")
@NamedQuery(name="TmpAccintfd.findAll", query="SELECT t FROM TmpAccintfd t")
public class TmpAccintfd implements Serializable {
