...
/**
 * The persistent class for the CLVW_LOAN_DETAILS database table.
 * 
 */
@Entity
@Table(name="CLVW_LOAN_DETAILS")
@NamedQuery(name="ClvwLoanDetail.findAll", query="SELECT c FROM ClvwLoanDetail c")
public class ClvwLoanDetail implements Serializable {
	...
	@Column(name="PEN_PRE_PAID")
	private BigDecimal penPrePaid;
	...
	public BigDecimal getPenPrePaid() {
		return this.penPrePaid;
	}

	public void setPenPrePaid(BigDecimal penPrePaid) {
		this.penPrePaid = penPrePaid;
	}
	...
	public BigDecimal getSpeCode() {
		return this.speCode;
	}

	public void setSpeCode(BigDecimal speCode) {
