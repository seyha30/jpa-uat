...
/**
 * The persistent class for the TMP_CUSTSTATE40 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE40")
@NamedQuery(name="TmpCuststate40.findAll", query="SELECT t FROM TmpCuststate40 t")
public class TmpCuststate40 implements Serializable {
