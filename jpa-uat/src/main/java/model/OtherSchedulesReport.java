...
/**
 * The persistent class for the OTHER_SCHEDULES_REPORT database table.
 * 
 */
@Entity
@Table(name="OTHER_SCHEDULES_REPORT")
@NamedQuery(name="OtherSchedulesReport.findAll", query="SELECT o FROM OtherSchedulesReport o")
public class OtherSchedulesReport implements Serializable {
