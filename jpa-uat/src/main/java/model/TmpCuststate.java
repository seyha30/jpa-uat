...
/**
 * The persistent class for the TMP_CUSTSTATE database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE")
@NamedQuery(name="TmpCuststate.findAll", query="SELECT t FROM TmpCuststate t")
public class TmpCuststate implements Serializable {
	...
	public BigDecimal getOdm() {
		return this.odm;
	}

	public void setOdm(BigDecimal odm) {
		this.odm = odm;
	}
