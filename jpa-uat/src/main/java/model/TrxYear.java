...
/**
 * The persistent class for the TRX_YEAR database table.
 * 
 */
@Entity
@Table(name="TRX_YEAR")
@NamedQuery(name="TrxYear.findAll", query="SELECT t FROM TrxYear t")
public class TrxYear implements Serializable {
