...
/**
 * The persistent class for the TMP_CUSTSTATE41 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE41")
@NamedQuery(name="TmpCuststate41.findAll", query="SELECT t FROM TmpCuststate41 t")
public class TmpCuststate41 implements Serializable {
