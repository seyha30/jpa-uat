...
/**
 * The persistent class for the NA_ACCRUED_HISTORY_MASTER database table.
 * 
 */
@Entity
@Table(name="NA_ACCRUED_HISTORY_MASTER")
@NamedQuery(name="NaAccruedHistoryMaster.findAll", query="SELECT n FROM NaAccruedHistoryMaster n")
public class NaAccruedHistoryMaster implements Serializable {
