...
/**
 * The persistent class for the CLVW_LOAN_DUE_WTH_SA database table.
 * 
 */
@Entity
@Table(name="CLVW_LOAN_DUE_WTH_SA")
@NamedQuery(name="ClvwLoanDueWthSa.findAll", query="SELECT c FROM ClvwLoanDueWthSa c")
public class ClvwLoanDueWthSa implements Serializable {
	...
	@Column(name="GROSS_DUE")
	private BigDecimal grossDue;
	...
	public BigDecimal getGrossDue() {
		return this.grossDue;
	}

	public void setGrossDue(BigDecimal grossDue) {
		this.grossDue = grossDue;
	}
