...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_30 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_30")
@NamedQuery(name="SysExportSchema30.findAll", query="SELECT s FROM SysExportSchema30 s")
public class SysExportSchema30 implements Serializable {
