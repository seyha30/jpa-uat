...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_12 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_12")
@NamedQuery(name="SysExportSchema12.findAll", query="SELECT s FROM SysExportSchema12 s")
public class SysExportSchema12 implements Serializable {
