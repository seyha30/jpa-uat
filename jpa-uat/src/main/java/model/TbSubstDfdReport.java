...
/**
 * The persistent class for the TB_SUBST_DFD_REPORT database table.
 * 
 */
@Entity
@Table(name="TB_SUBST_DFD_REPORT")
@NamedQuery(name="TbSubstDfdReport.findAll", query="SELECT t FROM TbSubstDfdReport t")
public class TbSubstDfdReport implements Serializable {
