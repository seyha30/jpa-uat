...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_02 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_02")
@NamedQuery(name="SysExportSchema02.findAll", query="SELECT s FROM SysExportSchema02 s")
public class SysExportSchema02 implements Serializable {
