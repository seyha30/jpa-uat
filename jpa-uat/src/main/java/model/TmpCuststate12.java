...
/**
 * The persistent class for the TMP_CUSTSTATE12 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE12")
@NamedQuery(name="TmpCuststate12.findAll", query="SELECT t FROM TmpCuststate12 t")
public class TmpCuststate12 implements Serializable {
