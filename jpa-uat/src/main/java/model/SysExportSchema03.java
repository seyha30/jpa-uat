...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_03 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_03")
@NamedQuery(name="SysExportSchema03.findAll", query="SELECT s FROM SysExportSchema03 s")
public class SysExportSchema03 implements Serializable {
