...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_23 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_23")
@NamedQuery(name="SysExportSchema23.findAll", query="SELECT s FROM SysExportSchema23 s")
public class SysExportSchema23 implements Serializable {
