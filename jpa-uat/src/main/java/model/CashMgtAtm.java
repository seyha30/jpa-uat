...
/**
 * The persistent class for the CASH_MGT_ATM database table.
 * 
 */
@Entity
@Table(name="CASH_MGT_ATM")
@NamedQuery(name="CashMgtAtm.findAll", query="SELECT c FROM CashMgtAtm c")
public class CashMgtAtm implements Serializable {
