...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_26 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_26")
@NamedQuery(name="SysExportSchema26.findAll", query="SELECT s FROM SysExportSchema26 s")
public class SysExportSchema26 implements Serializable {
