...
/**
 * The persistent class for the TMP_CUSTSTATE29 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE29")
@NamedQuery(name="TmpCuststate29.findAll", query="SELECT t FROM TmpCuststate29 t")
public class TmpCuststate29 implements Serializable {
