...
/**
 * The persistent class for the D_LOAN_ACCR_REPORT_TEMP database table.
 * 
 */
@Entity
@Table(name="D_LOAN_ACCR_REPORT_TEMP")
@NamedQuery(name="DLoanAccrReportTemp.findAll", query="SELECT d FROM DLoanAccrReportTemp d")
public class DLoanAccrReportTemp implements Serializable {
