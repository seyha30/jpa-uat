...
/**
 * The persistent class for the TMP_CUSTSTATE22 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE22")
@NamedQuery(name="TmpCuststate22.findAll", query="SELECT t FROM TmpCuststate22 t")
public class TmpCuststate22 implements Serializable {
