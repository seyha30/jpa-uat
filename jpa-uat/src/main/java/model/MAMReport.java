...
/**
 * The persistent class for the M_A_M_REPORTS database table.
 * 
 */
@Entity
@Table(name="M_A_M_REPORTS")
@NamedQuery(name="MAMReport.findAll", query="SELECT m FROM MAMReport m")
public class MAMReport implements Serializable {
