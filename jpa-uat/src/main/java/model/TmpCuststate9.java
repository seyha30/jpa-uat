...
/**
 * The persistent class for the TMP_CUSTSTATE9 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE9")
@NamedQuery(name="TmpCuststate9.findAll", query="SELECT t FROM TmpCuststate9 t")
public class TmpCuststate9 implements Serializable {
