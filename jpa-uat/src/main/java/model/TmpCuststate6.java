...
/**
 * The persistent class for the TMP_CUSTSTATE6 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE6")
@NamedQuery(name="TmpCuststate6.findAll", query="SELECT t FROM TmpCuststate6 t")
public class TmpCuststate6 implements Serializable {
