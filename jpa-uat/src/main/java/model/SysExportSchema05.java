...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_05 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_05")
@NamedQuery(name="SysExportSchema05.findAll", query="SELECT s FROM SysExportSchema05 s")
public class SysExportSchema05 implements Serializable {
