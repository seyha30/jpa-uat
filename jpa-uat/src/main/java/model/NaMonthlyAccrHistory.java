...
/**
 * The persistent class for the NA_MONTHLY_ACCR_HISTORY database table.
 * 
 */
@Entity
@Table(name="NA_MONTHLY_ACCR_HISTORY")
@NamedQuery(name="NaMonthlyAccrHistory.findAll", query="SELECT n FROM NaMonthlyAccrHistory n")
public class NaMonthlyAccrHistory implements Serializable {
