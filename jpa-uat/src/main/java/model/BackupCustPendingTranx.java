...
/**
 * The persistent class for the BACKUP_CUST_PENDING_TRANX database table.
 * 
 */
@Entity
@Table(name="BACKUP_CUST_PENDING_TRANX")
@NamedQuery(name="BackupCustPendingTranx.findAll", query="SELECT b FROM BackupCustPendingTranx b")
public class BackupCustPendingTranx implements Serializable {
