...
/**
 * The persistent class for the TMP_CUSTSTATE60 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE60")
@NamedQuery(name="TmpCuststate60.findAll", query="SELECT t FROM TmpCuststate60 t")
public class TmpCuststate60 implements Serializable {
