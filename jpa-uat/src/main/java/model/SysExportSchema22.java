...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_22 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_22")
@NamedQuery(name="SysExportSchema22.findAll", query="SELECT s FROM SysExportSchema22 s")
public class SysExportSchema22 implements Serializable {
