...
/**
 * The persistent class for the TMP_CUSTSTATE36 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE36")
@NamedQuery(name="TmpCuststate36.findAll", query="SELECT t FROM TmpCuststate36 t")
public class TmpCuststate36 implements Serializable {
