...
/**
 * The persistent class for the RE_SCHEDULES database table.
 * 
 */
@Entity
@Table(name="RE_SCHEDULES")
@NamedQuery(name="ReSchedule.findAll", query="SELECT r FROM ReSchedule r")
public class ReSchedule implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name="RE_SCHEDULE_ID")
