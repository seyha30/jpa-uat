...
/**
 * The persistent class for the DUMP_EXPECT_REPAYMENT database table.
 * 
 */
@Entity
@Table(name="DUMP_EXPECT_REPAYMENT")
@NamedQuery(name="DumpExpectRepayment.findAll", query="SELECT d FROM DumpExpectRepayment d")
public class DumpExpectRepayment implements Serializable {
