...
/**
 * The persistent class for the TMP_TRANXAMT15 database table.
 * 
 */
@Entity
@Table(name="TMP_TRANXAMT15")
@NamedQuery(name="TmpTranxamt15.findAll", query="SELECT t FROM TmpTranxamt15 t")
public class TmpTranxamt15 implements Serializable {
