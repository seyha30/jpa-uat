...
/**
 * The persistent class for the NA_MONTHLY_OTHER_HISTORIES database table.
 * 
 */
@Entity
@Table(name="NA_MONTHLY_OTHER_HISTORIES")
@NamedQuery(name="NaMonthlyOtherHistory.findAll", query="SELECT n FROM NaMonthlyOtherHistory n")
public class NaMonthlyOtherHistory implements Serializable {
	...
	private BigDecimal installType;
	...
	private BigDecimal noInstallment;
	...
	public BigDecimal getInstallType() {
		return this.installType;
	}

	public void setInstallType(BigDecimal installType) {
	...
	public BigDecimal getNoInstallment() {
		return this.noInstallment;
	}

	public void setNoInstallment(BigDecimal noInstallment) {
