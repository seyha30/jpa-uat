...
/**
 * The persistent class for the TMP_TRANXAMT116 database table.
 * 
 */
@Entity
@Table(name="TMP_TRANXAMT116")
@NamedQuery(name="TmpTranxamt116.findAll", query="SELECT t FROM TmpTranxamt116 t")
public class TmpTranxamt116 implements Serializable {
