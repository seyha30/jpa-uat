...
/**
 * The persistent class for the SA_ACCRUED_BACKUP database table.
 * 
 */
@Entity
@Table(name="SA_ACCRUED_BACKUP")
@NamedQuery(name="SaAccruedBackup.findAll", query="SELECT s FROM SaAccruedBackup s")
public class SaAccruedBackup implements Serializable {
