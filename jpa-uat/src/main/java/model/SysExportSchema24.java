...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_24 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_24")
@NamedQuery(name="SysExportSchema24.findAll", query="SELECT s FROM SysExportSchema24 s")
public class SysExportSchema24 implements Serializable {
