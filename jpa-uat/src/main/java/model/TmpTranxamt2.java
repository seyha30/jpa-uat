...
/**
 * The persistent class for the TMP_TRANXAMT2 database table.
 * 
 */
@Entity
@Table(name="TMP_TRANXAMT2")
@NamedQuery(name="TmpTranxamt2.findAll", query="SELECT t FROM TmpTranxamt2 t")
public class TmpTranxamt2 implements Serializable {
