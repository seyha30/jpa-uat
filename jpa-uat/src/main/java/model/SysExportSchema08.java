...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_08 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_08")
@NamedQuery(name="SysExportSchema08.findAll", query="SELECT s FROM SysExportSchema08 s")
public class SysExportSchema08 implements Serializable {
