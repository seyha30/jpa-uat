...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_07 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_07")
@NamedQuery(name="SysExportSchema07.findAll", query="SELECT s FROM SysExportSchema07 s")
public class SysExportSchema07 implements Serializable {
