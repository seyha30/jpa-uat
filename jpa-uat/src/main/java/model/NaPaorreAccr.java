...
/**
 * The persistent class for the NA_PAORRE_ACCR database table.
 * 
 */
@Entity
@Table(name="NA_PAORRE_ACCR")
@NamedQuery(name="NaPaorreAccr.findAll", query="SELECT n FROM NaPaorreAccr n")
public class NaPaorreAccr implements Serializable {
