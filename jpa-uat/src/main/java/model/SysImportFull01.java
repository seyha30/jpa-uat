...
/**
 * The persistent class for the SYS_IMPORT_FULL_01 database table.
 * 
 */
@Entity
@Table(name="SYS_IMPORT_FULL_01")
@NamedQuery(name="SysImportFull01.findAll", query="SELECT s FROM SysImportFull01 s")
public class SysImportFull01 implements Serializable {
	...
	@Lob
	@Column(name="TARGET_XML_CLOB")
	private String targetXmlClob;
	...
	public String getTargetXmlClob() {
		return this.targetXmlClob;
	}

	public void setTargetXmlClob(String targetXmlClob) {
		this.targetXmlClob = targetXmlClob;
	}
