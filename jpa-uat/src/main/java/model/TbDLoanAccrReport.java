...
/**
 * The persistent class for the TB_D_LOAN_ACCR_REPORT database table.
 * 
 */
@Entity
@Table(name="TB_D_LOAN_ACCR_REPORT")
@NamedQuery(name="TbDLoanAccrReport.findAll", query="SELECT t FROM TbDLoanAccrReport t")
public class TbDLoanAccrReport implements Serializable {
