...
/**
 * The persistent class for the TMP_CUSTSTATE24 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE24")
@NamedQuery(name="TmpCuststate24.findAll", query="SELECT t FROM TmpCuststate24 t")
public class TmpCuststate24 implements Serializable {
