...
/**
 * The persistent class for the TMP_CUSTSTATE14 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE14")
@NamedQuery(name="TmpCuststate14.findAll", query="SELECT t FROM TmpCuststate14 t")
public class TmpCuststate14 implements Serializable {
