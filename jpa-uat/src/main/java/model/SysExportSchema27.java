...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_27 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_27")
@NamedQuery(name="SysExportSchema27.findAll", query="SELECT s FROM SysExportSchema27 s")
public class SysExportSchema27 implements Serializable {
