...
/**
 * The persistent class for the FIXED_DEPOSIT_MASTER database table.
 * 
 */
@Entity
@Table(name="FIXED_DEPOSIT_MASTER")
@NamedQuery(name="FixedDepositMaster.findAll", query="SELECT f FROM FixedDepositMaster f")
public class FixedDepositMaster implements Serializable {
	...
	//bi-directional many-to-one association to InterestType
	@ManyToOne
	@JoinColumn(name="PERIOD_ID")
	private InterestType interestType;

	public FixedDepositMaster() {
	}
