...
/**
 * The persistent class for the TRANX_MASTERX database table.
 * 
 */
@Entity
@Table(name="TRANX_MASTERX")
@NamedQuery(name="TranxMasterx.findAll", query="SELECT t FROM TranxMasterx t")
public class TranxMasterx implements Serializable {
