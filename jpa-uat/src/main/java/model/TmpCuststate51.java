...
/**
 * The persistent class for the TMP_CUSTSTATE51 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE51")
@NamedQuery(name="TmpCuststate51.findAll", query="SELECT t FROM TmpCuststate51 t")
public class TmpCuststate51 implements Serializable {
