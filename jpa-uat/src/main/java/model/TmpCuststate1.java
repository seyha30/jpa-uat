...
/**
 * The persistent class for the TMP_CUSTSTATE1 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE1")
@NamedQuery(name="TmpCuststate1.findAll", query="SELECT t FROM TmpCuststate1 t")
public class TmpCuststate1 implements Serializable {
