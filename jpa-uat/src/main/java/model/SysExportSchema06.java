...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_06 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_06")
@NamedQuery(name="SysExportSchema06.findAll", query="SELECT s FROM SysExportSchema06 s")
public class SysExportSchema06 implements Serializable {
