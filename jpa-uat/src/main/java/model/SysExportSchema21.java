...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_21 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_21")
@NamedQuery(name="SysExportSchema21.findAll", query="SELECT s FROM SysExportSchema21 s")
public class SysExportSchema21 implements Serializable {
