...
/**
 * The persistent class for the TMP_CUSTSTATE2 database table.
 * 
 */
@Entity
@Table(name="TMP_CUSTSTATE2")
@NamedQuery(name="TmpCuststate2.findAll", query="SELECT t FROM TmpCuststate2 t")
public class TmpCuststate2 implements Serializable {
