...
/**
 * The persistent class for the SYS_EXPORT_SCHEMA_18 database table.
 * 
 */
@Entity
@Table(name="SYS_EXPORT_SCHEMA_18")
@NamedQuery(name="SysExportSchema18.findAll", query="SELECT s FROM SysExportSchema18 s")
public class SysExportSchema18 implements Serializable {
